parcelRequire = function (e, r, t, n) {
    ...
    "XR92": [function (require, module, exports) {
        ...
        function e() {
            var e = ["历数不尽的星辰<br>只有在诞生和陨落时最为迷人","实践是检验真理的唯一标准", "欢迎大家光临星象馆<br>这里有着无论何时永远不会消失<br>美丽的无穷光辉<br>满天的星星等候着大家的到来"],
                i = o(0, e.length - 1);
            t("#slogan").html(e[i])
        }
        ...
        delete Object.prototype.document, delete Object.prototype.location, window.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
            ...
            function w() {
                u(), ++c > 150 && c % 8 == 0 && (a.fillStyle = "rgba(0,0,0,.08)", a.fillRect(-3 * n, -3 * n, 6 * n, 6 * n)), f(.025)
            }
            ...
            a.fillStyle = "rgba(0,0,0,0)", a.fillRect(0, 0, t, e), a.lineCap = "round";
            ...
            a.translate(p, 0), function t() {
                ...
                i.width = t = i.offsetWidth, i.height = e = i.offsetHeight, a.fillStyle = "rgba(0,0,0,0)", a.fillRect(0, 0, t, e)
            }
